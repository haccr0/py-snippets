...
plt.plot(df["date"], df["min_temp"], label="Min Temperature", marker="o", color="violet")
plt.xlabel("DATE", color="blue")
plt.ylabel("TEMPERATURE (°C)", color="blue")
plt.title("DAILY MAX AND MIN TEMPERATURES FOR THE PAST WEEK", fontsize=14, fontweight="bold", color="red")
plt.legend()
